...
text1 = ("Welcome to Algorithms and Data Structures!")
text2 = ("First we will practice using the print command.")
text3 = ("This program prints three lines of the text on the screen.")
